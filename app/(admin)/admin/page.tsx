      ...
      <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-4 mb-8">
        {stats.map((stat) => (
          <Link key={stat.label} href={stat.href} className="group">
            <Card className={`${stat.bgColor} border-0 overflow-hidden transition-all hover:scale-[1.02] ${stat.urgent ? 'ring-2 ring-orange-500/50' : ''}`}>
              <CardContent className="p-6">
                <div className="flex items-start justify-between">
                  <div>
                    ...
                    <p className={`text-3xl font-bold text-white ${stat.isRevenue ? '' : 'tabular-nums'}`}>
                      {stat.value}
                    </p>
                  </div>
          ...
          <CardContent className="p-6">
            <div className="flex items-center gap-4">
              ...
              <div>
                ...
                <p className="text-2xl font-bold text-white tabular-nums">{clientCount || 0}</p>
              </div>
            </div>
          </CardContent>
        </Card>
          ...
          <CardContent className="p-6">
            <div className="flex items-center gap-4">
              ...
              <div>
                ...
                <p className="text-2xl font-bold text-white tabular-nums">{allOrders?.length || 0}</p>
              </div>
            </div>
          </CardContent>
        </Card>
