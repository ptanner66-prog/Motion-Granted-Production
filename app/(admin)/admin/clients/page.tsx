  ...
  return (
    <div className="p-6 lg:p-8 max-w-7xl mx-auto">
      ...
      <div className="mb-8">
        ...
        <p className="text-gray-400 mt-1">View and manage all registered clients</p>
      </div>
      ...
      <Card className="bg-gray-900 border-gray-800">
        <CardHeader className="border-b border-gray-800">
          <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
            <CardTitle className="text-lg font-semibold text-white">All Clients</CardTitle>
          </div>
        </CardHeader>
        <CardContent className="p-0">
          {clientsWithOrders.length === 0 ? (
            <div className="py-12 text-center">
              ...
              <p className="text-gray-500">Clients will appear here when they register</p>
            </div>
          ) : (
                      ...
                      {client.states_licensed && client.states_licensed.length > 0 && (
                        <div className="flex items-center gap-1">
                          {client.states_licensed.slice(0, 2).map((state: string) => (
                            <span
                              key={state}
                              className="px-2 py-0.5 text-xs font-medium bg-gray-800 text-gray-400 rounded"
                            >
                              {state}
                            </span>
                          ))}
